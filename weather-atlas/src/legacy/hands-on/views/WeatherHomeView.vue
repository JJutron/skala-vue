...
const showDetail = (city) => {
  router.push('/archive/live/weather/' + city.id)
}
...
<template>
  <div class="home">
    ...
    <h2 id="hw-02" class="homework-split">과제 2: 날씨 (컴포지션)</h2>
    ...
    <h2 id="hw-03" class="homework-split">과제 3: 날씨 (컴포넌트)</h2>
    ...
    <h2 id="hw-04" class="homework-4">과제 4: 날씨 (Pinia)</h2>
    <UnitToggler />
    </div>
    <BaseDashboardCard>
    ...
    <div class="toolbar-5">
      <h2 id="hw-05" class="homework-5">과제 5: 날씨 (Axios)</h2>
      <UnitToggler />
    </div>
    <BaseDashboardCard>
    ...
    <div class="toolbar-6">
      <h2 id="hw-06" class="homework-6">과제 6: 날씨 (UI Library)</h2>
      <el-switch
