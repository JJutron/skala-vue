...
| 항목 | 이 저장소에서 |
| ---- | ------------- |
| 기본 문법 (25) | Code Challenge 지시자 · Composition API · 컴포넌트, 날씨 카드 분리 |
| 확장 문법 (25) | Vue Router (지연 로딩, 동적 파라미터, 404) |
| 앱 완성도 (25) | day3 검색 · 카드 · 상세 · 소개 · 통계 · 404. 커스텀은 안성, `/stats` |
| 수업 참여 (25) | 위 Code Challenge / Hands on 목록이 실습 기록 |
